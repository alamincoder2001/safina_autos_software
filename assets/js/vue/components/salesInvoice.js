const salesInvoice = Vue.component("sales-invoice", {
  template: `
        <div>
            <div class="row">
                <div class="col-xs-2">
                    <a href="" v-on:click.prevent="print"><i class="fa fa-print"></i> Print A4</a>
                </div>
                <div class="col-xs-2">
                    <a href="" v-on:click.prevent="printPos"><i class="fa fa-print"></i> Print Pos</a>
                </div>
            ...
            <div id="invoiceContent">
                        ...
                        <table _a584de>
                            <thead>
                                <tr>
                                    ...
                                    <td>Description</td>
                                    <td>Image</td>
                                    <td style="width:80px">Net Weight</td>
                                    <td>Qnty</td>
                                    <td>Unit</td>
                                    <td>Unit Price</td>
                                    <td>Total</td>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td>
                                        <img v-if="product.image" :src="'/uploads/products/' + product.image" style="width: 50px;height: 50px;">
								    </td>
                                ...
                                <tr> 
                                    ...
                                    <td style="text-align:center; font-weight:bold;">{{ cart.reduce((prev, curr) => { return prev + parseFloat(curr.net_weight)},0)  }} </td>
                                    <td style="text-align:center; font-weight:bold;">{{ cart.reduce((prev, curr) => { return prev + parseFloat(curr.SaleDetails_TotalQuantity)},0) }} </td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        <strong>Note: </strong>
                        <p style="white-space: pre-line">{{ sales.SaleMaster_Description }}</p><br><br>
                ...
                <div class="row" style="border-bottom:1px solid #ccc;margin-bottom:5px;padding-bottom:6px;margin-top:20px">
