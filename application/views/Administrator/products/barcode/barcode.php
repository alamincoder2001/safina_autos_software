			...
			<section class="" id="printButton" style="background:#f4f4f4;height:200px;">
			 <div class="">
			  ...
			  <div class="form-group">
				...
				<label class="control-label col-sm-2" for="Price">Sl No/Part No </label>
				<div class="col-sm-2">
					<input type="text" name="article" class="form-control mytext" placeholder="Sl No/Part No" value="<?php echo $product->part_no; ?>"/>
				</div>
				<div class="col-sm-2">
