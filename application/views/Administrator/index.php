...
<body class="skin-2">
	<div id="navbar" class="navbar navbar-default ace-save-state navbar-fixed-top" style="background:#3e2e6b !important;">
		<div class="navbar-container ace-save-state" id="navbar-container" style="display:flex">
			...
			<div class="navbar-header pull-left" style="margin:0">
			...
			<div style="display: flex;margin-left:0">
				<div class="extra-menu-part" style="margin-left:20px;position:relative">
					<a data-toggle="dropdown" href="#" class="dropdown-toggle">
						<big>Product Info</big>
					...
					<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
						...
						<li>
							<a class="top-a-btn" href="<?php echo base_url(); ?>product_ledger"  >Product Ledger</a>
						</li>
					</ul>
					<!-- 						
					<a href="<?php echo base_url(); ?>purchase">Purchase Entry</a> -->
				...
				<div class="extra-menu-part" style="position:relative;margin-left:5px">
					...
					<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
						...
						<li>
							<a class="top-a-btn" href="<?php echo base_url(); ?>salesrecord/Delivered" >Sales Delivered</a>
						</li>
					</ul>
					<!-- 						
					<a href="<?php echo base_url(); ?>purchase">Purchase Entry</a> -->
				...
				<div class="extra-menu-part" style="position:relative;margin-left:5px">
					...
					<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
						<li>
							<a class="top-a-btn" href="<?php echo base_url(); ?>purchase"  >Purchase Entry</a>
						</li>
						<li>
							<a class="top-a-btn" href="<?php echo base_url(); ?>purchaseRecord"  >Purchase Record</a>
						</li>
			...
			<div class="navbar-buttons navbar-header pull-right" role="navigation" style="margin-right:0">
		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb position-sticky">
							<li>
