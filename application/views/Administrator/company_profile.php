					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group" style="margin-top:15px">
								...
								<div>
									<input name="mobile" type="text" id="Company_name" value="<?php echo $selected->mobile; ?>" class="form-control" />
							...
							<div class="form-group" style="margin-top:15px">
								...
								<div>
									<input name="email" type="text" id="Company_name" value="<?php echo $selected->email; ?>" class="form-control" />
							...
							<div class="form-group" style="margin-top:15px">
								...
								<div>
									<textarea id="Description" name="address" class="form-control"><?php echo $selected->address; ?></textarea>
								</div>
							</div>

							<div class="form-group" style="margin-top:15px">
								<label class="control-label" for="form-field-1">About Image </label>
								<div>
									<input name="about_image" id="about_image" type="file" onchange="readURL2(this)" class="form-control" style="height:35px;" />
								</div>
								<?php
								if ($selected->about_image) { ?>
									<img id="preview2" src="<?php echo  base_url() . 'uploads/about_image/' . $selected->about_image ?>" style="width:100px;height:100px">
								<?php }
								?>
							...
							<div class="form-group" style="margin-top:15px">
								<label class="control-label" for="form-field-1">Website Logo </label>
								<div>
									<input name="website_logo" id="website_logo" type="file" onchange="readURL3(this)" class="form-control" style="height:35px;" />
								</div>
								<?php
								if ($selected->website_logo) { ?>
									<img id="preview2" src="<?php echo  base_url() . 'uploads/website_logo/' . $selected->website_logo ?>" style="width:100px;height:100px">
								<?php }
								?>
								<img id="preview3" src="#" style="width:100px;height:100px" hidden>
							</div>
						...
						<div class="col-md-6">
							<div class="form-group" style="margin-top:15px">
								<label class="control-label" for="form-field-1">About Description </label>
								<div>
									<textarea id="Description" rows="7" id="about_description" name="about_description" class="form-control"><?php echo $selected->about_description; ?></textarea>
								</div>
							</div>

							<div class="form-group" style="margin-top:15px">
								<label class="control-label" for="form-field-1">Return Policy </label>
								<div>
									<textarea id="Description" rows="7" id="about_description" name="return_policy" class="form-control"><?php echo $selected->return_policy; ?></textarea>
								</div>
							</div>
							<div class="form-group" style="margin-top:15px">
								<label class="control-label" for="form-field-1">Facebook</label>
								<div>
								<input name="facebook" type="text"  value="<?php echo $selected->facebook; ?>" class="form-control" />
								</div>
							</div>
							<div class="form-group" style="margin-top:15px">
								<label class="control-label" for="form-field-1">Youtube</label>
								<div>
								<input name="youtube" type="text"  value="<?php echo $selected->youtube; ?>" class="form-control" />
								</div>
							</div>
							<div class="form-group" style="margin-top:15px">
								<label class="control-label" for="form-field-1">Twitter</label>
								<div>
								<input name="twitter" type="text"  value="<?php echo $selected->twitter; ?>" class="form-control" />
								</div>
							</div>
							<div class="form-group" style="margin-top:15px">
								<label class="control-label" for="form-field-1">Linkedin</label>
								<div>
								<input name="linkedin" type="text"  value="<?php echo $selected->linkedin; ?>" class="form-control" />
								</div>
							</div>
...
<div class="col-md-12" id="break"></div>
...
<script type="text/javascript">
	function Employee_submit(e) {
		...
		fd.append('about_description', $('#Company_name').val());
		fd.append('about_image', $('#about_image').val());
