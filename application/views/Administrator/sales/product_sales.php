...
<div id="sales" class="row">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			...
			<div class="form-group" v-if="sales.salesId != 0">
				<label class="col-sm-1 control-label no-padding-right">Status</label>
				<div class="col-sm-2">
					<select class="form-control" id="status" v-model="sales.sale_status" style="padding: 0;">
		...
		methods: {
			...
			async getSales() {
				await axios.post('/get_sales', {
					...
					this.sales.sale_status = sales.sale_status;
